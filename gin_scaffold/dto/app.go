...
type AppListOutput struct {
	...
	List  []AppListItemOutput `json:"list" form:"list" comment:"列表"  validate:""`
}
...
func (param *AppListInput) BindingValidParams(c *gin.Context) error {
...
func (param *AppDeleteInput) BindingValidParams(c *gin.Context) error {
	return public.DefaultGetValidParams(c, param)
}

type AppUpdateInput struct{}

func (param *AppUpdateInput) BindingValidParams(c *gin.Context) error {
	return public.DefaultGetValidParams(c, param)
}
...
func (param *APPAddHttpInput) BindingValidParams(c *gin.Context) error {
	return public.DefaultGetValidParams(c, param)
}
