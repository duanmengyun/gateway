...
type ServiceListInput struct {
	Info       string `json:"info" form:"info" comment:"查询信息" example:"http" validate:""`
	PageNumber int    `json:"PageNumber" form:"PageNumber" comment:"页数" example:"1" validate:"required"`
	PageSize   int    `json:"PageSize" form:"PageSize" comment:"一个页面中的服务数量" example:"20" validate:"required"`
}

// 输出应该是所有的services
type ServiceListOutput struct {
	Total int64                   `json:"total" form:"total" comment:"总数" example:"10" validate:""` //总数
...
type ServiceListItemOutput struct {
	...
	ServiceAddr string `json:"service_addr" form:"service_addr"` //服务地址，符合各种类型设置
	Qps         int64  `json:"qps" form:"qps"`                   //qps
	Qpd         int64  `json:"qpd" form:"qpd"`                   //qpd
	TotalNode   int    `json:"total_node" form:"total_node"`     //节点数，什么叫节点数
}
...
type CreateHTTPServiceInput struct {
	...
	ClientipFlowLimit int    `json:"clientipflowlimit" form:"clientip_flow_limit" comment:"客户端ip限流" example:"" validate:"min=0"`
	...
	WeightList             string `json:"weightlist" form:"weight_list" comment:"权重列表" example:"" validate:"required,valid_weightlist"`
...
type CreateTcpServiceInput struct {
	...
	HeaderTransfor    string `json:"HeaderTransfor" form:"header_transfor" comment:"header头转换" validate:""`
...
type CreateGrpcServiceInput struct {
	ServiceName       string `json:"service_name" form:"service_name" comment:"服务名称" validate:"required,valid_service_name"`
	ServiceDesc       string `json:"service_desc" form:"service_desc" comment:"服务描述" validate:"required"`
	Port              int    `json:"port" form:"port" comment:"端口，需要设置8001-8999范围内" validate:"required,min=8001,max=8999"`
...
func (param *CreateHTTPServiceInput) BindValidParam(c *gin.Context) error {
	return public.DefaultGetValidParams(c, param)
}
func (param *CreateGrpcServiceInput) BindValidParam(c *gin.Context) error {
	return public.DefaultGetValidParams(c, param)
}
func (param *CreateTcpServiceInput) BindValidParam(c *gin.Context) error {
	return public.DefaultGetValidParams(c, param)
}
...
func (param *UpdateTcpServiceInput) BindValidParam(c *gin.Context) error {
	return public.DefaultGetValidParams(c, param)
}
...
func (param *UpdateGrpcServiceInput) BindValidParam(c *gin.Context) error {
	return public.DefaultGetValidParams(c, param)
}
